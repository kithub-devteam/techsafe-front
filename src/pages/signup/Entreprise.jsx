    ...
    return (
        <div className="md:w-3/5 w-full h-max m-auto mt-7 flex flex-col gap-2">
            ...
            <div className="w-full h-[40px] rounded-xl  bg-[#E3E3E3] relative">
                ...
                <input type="text" className="w-full pl-10 rounded-xl h-full border-0 outline-0 bg-inherit text-base " name="entreprise" id="entreprise" placeholder="Nom d'entreprise" />
            </div>
            <div className="w-full h-[40px] rounded-xl  bg-[#E3E3E3] relative">
            ...
            <div className="w-full h-[40px] rounded-xl  bg-[#E3E3E3] relative">
                ...
                <input type="text" className="w-full pl-10 rounded-xl h-full border-0 outline-0 bg-inherit " name="taille" id="taille" placeholder="Taille d'entreprise" />
            </div>
            <div className="w-full h-[40px] rounded-xl  bg-[#E3E3E3] relative">
                <MdCategory className="text-[#606060] text-2xl absolute left-2 top-1/2 -translate-y-1/2" />
                <input type="text" className="w-full pl-10 rounded-xl h-full border-0 outline-0 bg-inherit" name="secteur" id="secteur" placeholder="Secteur d'activité" />
            </div>
